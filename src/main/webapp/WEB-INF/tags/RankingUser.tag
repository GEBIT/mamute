...
<div class="ranking-user">
	<img class="user-image" src="${isTagRanking ? user.getSmallPhoto(env.get('gravatar.avatar.url'), env.get('robohash.url')) : user.getMediumPhoto(env.get('gravatar.avatar.url'), env.get('robohash.url'))}"/>
	<div class="user-info">
